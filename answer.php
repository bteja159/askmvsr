...
<section class="engine"><a rel="external" href=".">ASK MVSR</a></section><section class="mbr-section mbr-after-navbar" id="testimonials4-8" style="background-color: rgb(0, 0, 0); padding-top: 120px; padding-bottom: 120px;">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 text-xs-center">
                        <h3 class="mbr-section-title display-2"><?php echo $_GET["q"]; ?>?</h3>
            ...
            <div class="row">
                ...
                <div class="col-xs-12">
                    ...
                    <div class="mbr-testimonial card">
                            ...
                            <form action="insert_answer.php" method="get" data-form-title="Suggest">
                            
                            <input type=hidden name=qid value=<?php echo $_GET["qid"]; ?> >
                         
                          <div class="form-group">
                            <label class="form-control-label" for="form1-j-message"></label>
                            <textarea placeholder="Type your answer here...That will help many people out there..! Wanna be a popular writer?Type your name at the end of your answer:-)" required class="form-control" name="a" rows="7" data-form-field="Message" id="form1-j-message"></textarea>
                        </div>
