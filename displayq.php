...
$sql = "SELECT * FROM qs ORDER BY count";
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 text-xs-center">
                        <h3 class="mbr-section-title display-2">ANSWER</h3>
...
?>
 ...
 <font color=silver>&#9671</font>
   ...
   <a href="answer.php?qid=<?php  echo $row["id"]."&q=".$row["q"]; ?>">

<?php  echo "{$row["q"]}? - <font color=silver>{$row["count"]} Answers</font>"; ?>  
